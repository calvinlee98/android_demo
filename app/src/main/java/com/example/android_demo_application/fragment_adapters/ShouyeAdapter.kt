    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is BannerViewHolder) {
            ...
            holder.itemView.apply {
                ...
                typeText.text = itemList[position-1].type
            }
        }
    }
...
class ShouyeItem(val author: String, val publishTime: String, val title: String, val content: String, val type: String, val url: String)